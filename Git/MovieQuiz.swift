...
struct MovieQuiz: View {
    ...
    let actionKid:[String] = ["Spider Man into the Spiderverse - When bitten by a radioactive spider in the subway, Miles Morales develops mysterious powers transforming him into spiderman", "Harry Potter - A magical action movie, starring Emma Watson and Daniel Radcliffe, featuring an adventure three wizards go on to benefit society.", "Hunger Games - One boy and one girl are selected from each of 12 districts to fight to death in the annual hunger games until there is only one survivor", "The Maze Runner - A Fun North American film triology with dystopian action and adventure!","Skyscraper - An action-thriller featuring Dwayne Johnson, packed with mystery and anticipation!"]
